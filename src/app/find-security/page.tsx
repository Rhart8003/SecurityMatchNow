    ...
    <main className="request-page">
      ...
      <div className="container request-page-grid">
        <div className="request-aside">
          ...
          <p>We use your ZIP code and service requirements to identify security companies positioned to cover the assignment.</p>
          <ul><li>Location-aware provider matching</li><li>Provider verification framework</li><li>Multiple quotes in one place</li><li>No obligation to choose a provider</li></ul>
        ...
        <RequestForm initialZip={zip} initialService={service} urgent={urgent} resume={resume} />
      </div>
    </main>
  );
}
